  ...
  Future<List<HomeModel>> getHomes() async {
    return Future.value([
      ...
      HomeModel(
        ...
        price: '800',
        size: '104',
        location: 'La Platina, Salamanca, Madrid',
        latitude: 40.9659889,
        longitude: -5.686588,
        phone: '655 900 122',
        affordability: Affordability.affordable,
      ...
      HomeModel(
        ...
        description: 'Piso en el Paseo de Canalejas 67 - 6º B.A cinco minutos andando a la Plaza Mayor y a las Catedrales de Salamanca.Piso 130 m² reformado y decorado en 2017. Terraza en todo el perimetro de la casa. Aire acondicionado en toda la casa.Piso con Acceso a Internet WIFI130 m2',
        homeStateFor: HomeStateFor.share,
        imageUrl:
            'https://erasmusflat.com/sc1/upload/habitaciones/WhatsAppImage2020-08-19at20.18.431.jpeg',
        price: '400',
        size: '130',
        location: 'Delicias, Salamanca, Madrid',
        latitude: 40.9641642,
        longitude: -5.6601851,
        phone: '644 765 321',
        affordability: Affordability.affordable,
      ...
      HomeModel(
        ...
        price: '390.500',
        size: '120',
        location: 'Garrido norte, Salamanca, Madrid',
        latitude: 40.9743295,
        longitude: -5.6573738,
        phone: '621 987 235',
